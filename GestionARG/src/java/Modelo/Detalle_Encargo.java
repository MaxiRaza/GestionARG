...
public class Detalle_Encargo {
    ...
    private int id_detalle_encargp, id_encargo, id_producto;
    ...
    public Detalle_Encargo(int id_detalle_encargp, int id_encargo, int id_producto, float importe, float cantidad) {
        this.id_detalle_encargp = id_detalle_encargp;
    ...
    public int getId_detalle_encargp() {
        return id_detalle_encargp;
    }

    public void setId_detalle_encargp(int id_detalle_encargp) {
        this.id_detalle_encargp = id_detalle_encargp;
    }
